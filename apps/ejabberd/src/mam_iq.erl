...
-spec query_to_lookup_params(iq(), undefined | module()) -> map().
query_to_lookup_params(#iq{sub_el = QueryEl} = IQ, Module) ->
...
-spec form_to_lookup_params(iq(), undefined | module()) -> map().
form_to_lookup_params(#iq{sub_el = QueryEl} = IQ, Module) ->
    Params0 = common_lookup_params(QueryEl),
    Params = Params0#{
               %% Filtering by date.
               %% Start :: integer() | undefined
